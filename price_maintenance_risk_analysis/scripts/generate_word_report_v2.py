...
def generate_report(stock_code='300735.SZ', output_file='定增风险分析报告.docx'):
    ...
    market_table_data = [
        ...
        ['20日波动率', f'{market_data.get("volatility_30d", 0)*100:.2f}%'],
        ['60日波动率', f'{market_data.get("volatility_60d", 0)*100:.2f}%'],
        ['120日波动率', f'{market_data.get("volatility_120d", 0)*100:.2f}%'],
        ['250日波动率', f'{market_data.get("volatility_250d", 0)*100:.2f}%'],
        ['60日区间收益率', f'{((1 + market_data.get("annual_return_60d", 0)) ** (60/365.0) - 1)*100:+.2f}%'],
        ['60日年化收益率', f'{market_data.get("annual_return_60d", 0)*100:+.2f}%'],
        ['120日年化收益率', f'{market_data.get("annual_return_120d", 0)*100:+.2f}%'],
        ['250日年化收益率', f'{market_data.get("annual_return_250d", 0)*100:+.2f}%'],
