...
def generate_report(stock_code='300735.SZ', output_file='定增风险分析报告.docx'):
    ...
    try:
        ...
        # 获取个股历史PE数据（最近5年）
        stock_pe_data = analyzer.get_stock_pe_history(stock_code, days=1825)

        # 获取行业历史PE数据
        industry_name, industry_code, industry_pe_data = analyzer.get_industry_pe_history(stock_code, days=1825)
