...
def generate_report(stock_code='300735.SZ', output_file='定增风险分析报告.docx'):
    ...
    # ==================== 2.3 不同时间窗口风险指标分析 ====================
    add_paragraph(document, '')
    add_title(document, '2.4 不同时间窗口风险指标分析', level=2)
    ...
    # ==================== 2.5 发行价折扣敏感性分析 ====================
    add_paragraph(document, '')
    add_title(document, '2.5 发行价折扣敏感性分析', level=2)
    ...
    # ==================== 3.1 盈亏平衡价格敏感性分析 ====================
    add_paragraph(document, '')
    add_title(document, '3.1 盈亏平衡价格敏感性分析', level=2)
    ...
    # ==================== 3.2 多维度情景分析 ====================
    add_paragraph(document, '')
    add_title(document, '3.2 多维度情景分析', level=2)
    ...
    # ==================== 3.3 破发概率情景分析 ====================
    add_paragraph(document, '')
    add_title(document, '3.3 破发概率情景分析', level=2)
