...
def generate_report(stock_code='300735.SZ', output_file='定增风险分析报告.docx'):
    ...
    # ==================== 6.1 基于市场指数与行业的情景分析 ====================
    add_paragraph(document, '')
    add_title(document, '6.1 基于市场指数与行业的情景分析', level=2)
    ...
    if comprehensive_results:
        ...
        # ==================== 6.2 基于行业PE分位数的情景分析 ====================
        add_paragraph(document, '')
        add_title(document, '6.2 基于行业PE分位数的情景分析', level=2)
        ...
        # ==================== 6.3 基于个股PE分位数的情景分析 ====================
        add_paragraph(document, '')
        add_title(document, '6.3 基于个股PE分位数的情景分析', level=2)
        ...
        # ==================== 6.4 基于DCF估值的情景分析 ====================
        add_paragraph(document, '')
        add_title(document, '6.4 基于DCF估值的情景分析', level=2)
        ...
        # ==================== 6.5 情景综合分析汇总表 ====================
        add_paragraph(document, '')
        add_title(document, '6.5 情景综合分析汇总表', level=2)
