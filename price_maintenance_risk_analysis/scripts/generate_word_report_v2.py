...
def generate_report(stock_code='300735.SZ', output_file='定增风险分析报告.docx'):
    ...
    try:
        ...
        if os.path.exists(industry_data_file):
            ...
            add_paragraph(document, f"• MA20: {industry_data.get('ma_20', 0):.2f} 元")
            add_paragraph(document, f"• MA60: {industry_data.get('ma_60', 0):.2f} 元")
            add_paragraph(document, f"• MA120: {industry_data.get('ma_120', 0):.2f} 元")
            add_paragraph(document, f"• MA250: {industry_data.get('ma_250', 0):.2f} 元")
    ...
    add_table_data(document, window_headers, window_table_data, font_size=10.5)
